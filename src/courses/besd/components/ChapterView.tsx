  ...
  if (!chapter) {
    return (
      <div className="chapter">
        ...
        <Link to="/backend-interviews">← Back home</Link>
      </div>
    );
  }
  ...
  return (
    <article className="chapter">
      ...
      <div className="chapter__body markdown">
        <ReactMarkdown
          remarkPlugins={[remarkGfm, [remarkTermLinks, ["be"]]]}
      ...
      <nav className="chapter__nav">
        {prev ? (
          <Link to={`/backend-interviews/c/${prev.slug}`} className="chapter__navlink">
        ...
        {next ? (
          <Link to={`/backend-interviews/c/${next.slug}`} className="chapter__navlink chapter__navlink--right">
