  ...
  return (
    <article className="chapter">
      ...
      <div className="chapter__body markdown">
        <ReactMarkdown
          remarkPlugins={[remarkGfm, [remarkTermLinks, "fe"]]}
      ...
      <nav className="chapter__nav">
        {prev ? (
          <Link to={`/fe/c/${prev.slug}`} className="chapter__navlink">
        ...
        {next ? (
          <Link to={`/fe/c/${next.slug}`} className="chapter__navlink chapter__navlink--right">
