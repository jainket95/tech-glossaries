...
export const courses: CourseMeta[] = [
  ...
  },
  {
    ...
    tagline:
      '38 frontend system-design interview questions, each solved on two connected tracks: a RADIO frontend answer and a backend answer, wired together at the API contract.',
    accent: '#1d5b8f',
    path: '/system-design',
  },
];
