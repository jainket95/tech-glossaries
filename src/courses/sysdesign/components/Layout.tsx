...
export default function Layout() {
  ...
  return (
    <div className="course-sysdesign layout">
      <header className="topbar">
        ...
        <NavLink to="/system-design" end className="topbar__brand">
          <span className="topbar__mark">◧</span>
          <span className="topbar__title">System Design Interview Solutions</span>
